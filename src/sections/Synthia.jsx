...
const proyectos = [
  { id: "sokoban", title: "Sokoban", label: "Sokoban", href: "https://github.com/lauradiazmondejar/sokoban-inteligentes.git", github: "", img: "sokoban.png", top: "22%", left: "18%" },
  { id: "victini", title: "Victini", label: "IPOkemon", href: "https://github.com/lauradiazmondejar/VictiniLDM.git", github: "", img: "victini.png", top: "22%", left: "72%" },
  { id: "remotetypes", title: "RemoteTypes", label: "Remotetypes", href: "https://github.com/lauradiazmondejar/LAURA-DIAZ-REMOTETYPES.git", github: "", img: "remotetypes.png", top: "48%", left: "50%" },
  { id: "alfatrip", title: "AlfaTrip", label: "Alfatrip", href: "https://github.com/lauradiazmondejar/isi-alfatrip.git", github: "", img: "alfatrip.png", top: "70%", left: "28%" },
  { id: "geoparque", title: "Geoparque", label: "Geoparque ESIstencial", href: "https://github.com/lauradiazmondejar/geoparque_esistencial.git", github: "", img: "geoparque.png", top: "72%", left: "78%" },
];
      ...
      <div className="synthia-container">
        ...
        <div className="synthia-sky">
          {proyectos.map((p, i) => {
            ...
            const Label = <span className="synthia-label">{p.label || p.title}</span>;
            const Github = p.github && p.github !== "" ? (
              <a
